...
public class TreeNodeLevelsTest {
    ...
    public void testTreeNodeRoot() {
        TreeNode root = new TreeNode("Root", 0, 0);
        assertEquals(root.getLevel(), 0, 0);
    }

    @Test
    public void testTreeNodeLevelOne() {
        TreeNode root = new TreeNode("Root", 0, 0);
        TreeNode child = new TreeNode("Child 1", 0, 0);
        root.addChild(child);
    ...
    public void testTreeNodeLevelTwo() {
        TreeNode root = new TreeNode("Root", 0, 0);
        TreeNode child = new TreeNode("Child 1", 0, 0);
        TreeNode childTwo = new TreeNode("Child 2", 0, 0);
    ...
    public void testTreeNodeLevelThree() {
        ...
        TreeNode child = new TreeNode("Child 1", 0, 0);
        TreeNode childTwo = new TreeNode("Child 2", 0, 0);
        TreeNode childThree = new TreeNode("Child 3", 0, 0);
    ...
    public void testTreeNodeLevelFour() {
        ...
        TreeNode childTwo = new TreeNode("Child 2", 0, 0);
        TreeNode childThree = new TreeNode("Child 3", 0, 0);
        TreeNode childFour = new TreeNode("Child 4", 0, 0);
